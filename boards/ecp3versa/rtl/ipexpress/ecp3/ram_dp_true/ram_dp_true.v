...
/* Module Version: 7.2 */
/* C:\lscc\diamond\2.2\ispfpga\bin\nt\scuba.exe -w -n ram_dp_true -lang verilog -synth synplify -bus_exp 7 -bb -arch ep5c00 -type bram -wp 11 -rp 1010 -data_width 16 -rdata_width 16 -num_rows 4096 -byte 9 -writemodeA NORMAL -writemodeB NORMAL -cascade -1 -e  */
...
module ram_dp_true (DataInA, DataInB, ByteEnA, ByteEnB, AddressA, 
    ...
    DP16KC ram_dp_true_0_0_3 (.DIA0(DataInA[0]), .DIA1(DataInA[1]), .DIA2(DataInA[2]), 
        ...
        .DIA15(DataInA[15]), .DIA16(scuba_vlo), .DIA17(scuba_vlo), .ADA0(ByteEnA[0]), 
        ...
        .DIB15(DataInB[15]), .DIB16(scuba_vlo), .DIB17(scuba_vlo), .ADB0(ByteEnB[0]), 
    ...
    defparam ram_dp_true_1_0_2.REGMODE_B = "NOREG" ;
    defparam ram_dp_true_1_0_2.REGMODE_A = "NOREG" ;
    ...
    defparam ram_dp_true_2_0_1.REGMODE_B = "NOREG" ;
    defparam ram_dp_true_2_0_1.REGMODE_A = "NOREG" ;
    ...
    defparam ram_dp_true_3_0_0.REGMODE_B = "NOREG" ;
    defparam ram_dp_true_3_0_0.REGMODE_A = "NOREG" ;
    ...
    FD1P3DX FF_2 (.D(AddressA[11]), .SP(wren0_inv_g), .CK(ClockA), .CD(scuba_vlo), 
        .Q(addr011_ff))
             /* synthesis GSR="ENABLED" */;
    ...
    FD1P3DX FF_0 (.D(AddressB[11]), .SP(wren1_inv_g), .CK(ClockB), .CD(scuba_vlo), 
        .Q(addr111_ff))
             /* synthesis GSR="ENABLED" */;

    MUX41 mux_31 (.D0(mdout0_0_0), .D1(mdout0_1_0), .D2(mdout0_2_0), .D3(mdout0_3_0), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[0]));

    MUX41 mux_30 (.D0(mdout0_0_1), .D1(mdout0_1_1), .D2(mdout0_2_1), .D3(mdout0_3_1), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[1]));

    MUX41 mux_29 (.D0(mdout0_0_2), .D1(mdout0_1_2), .D2(mdout0_2_2), .D3(mdout0_3_2), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[2]));

    MUX41 mux_28 (.D0(mdout0_0_3), .D1(mdout0_1_3), .D2(mdout0_2_3), .D3(mdout0_3_3), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[3]));

    MUX41 mux_27 (.D0(mdout0_0_4), .D1(mdout0_1_4), .D2(mdout0_2_4), .D3(mdout0_3_4), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[4]));

    MUX41 mux_26 (.D0(mdout0_0_5), .D1(mdout0_1_5), .D2(mdout0_2_5), .D3(mdout0_3_5), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[5]));

    MUX41 mux_25 (.D0(mdout0_0_6), .D1(mdout0_1_6), .D2(mdout0_2_6), .D3(mdout0_3_6), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[6]));

    MUX41 mux_24 (.D0(mdout0_0_7), .D1(mdout0_1_7), .D2(mdout0_2_7), .D3(mdout0_3_7), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[7]));

    MUX41 mux_23 (.D0(mdout0_0_8), .D1(mdout0_1_8), .D2(mdout0_2_8), .D3(mdout0_3_8), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[8]));

    MUX41 mux_22 (.D0(mdout0_0_9), .D1(mdout0_1_9), .D2(mdout0_2_9), .D3(mdout0_3_9), 
        .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[9]));

    MUX41 mux_21 (.D0(mdout0_0_10), .D1(mdout0_1_10), .D2(mdout0_2_10), 
        .D3(mdout0_3_10), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[10]));

    MUX41 mux_20 (.D0(mdout0_0_11), .D1(mdout0_1_11), .D2(mdout0_2_11), 
        .D3(mdout0_3_11), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[11]));

    MUX41 mux_19 (.D0(mdout0_0_12), .D1(mdout0_1_12), .D2(mdout0_2_12), 
        .D3(mdout0_3_12), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[12]));

    MUX41 mux_18 (.D0(mdout0_0_13), .D1(mdout0_1_13), .D2(mdout0_2_13), 
        .D3(mdout0_3_13), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[13]));

    MUX41 mux_17 (.D0(mdout0_0_14), .D1(mdout0_1_14), .D2(mdout0_2_14), 
        .D3(mdout0_3_14), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[14]));

    MUX41 mux_16 (.D0(mdout0_0_15), .D1(mdout0_1_15), .D2(mdout0_2_15), 
        .D3(mdout0_3_15), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[15]));

    MUX41 mux_15 (.D0(mdout1_0_0), .D1(mdout1_1_0), .D2(mdout1_2_0), .D3(mdout1_3_0), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[0]));

    MUX41 mux_14 (.D0(mdout1_0_1), .D1(mdout1_1_1), .D2(mdout1_2_1), .D3(mdout1_3_1), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[1]));

    MUX41 mux_13 (.D0(mdout1_0_2), .D1(mdout1_1_2), .D2(mdout1_2_2), .D3(mdout1_3_2), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[2]));

    MUX41 mux_12 (.D0(mdout1_0_3), .D1(mdout1_1_3), .D2(mdout1_2_3), .D3(mdout1_3_3), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[3]));

    MUX41 mux_11 (.D0(mdout1_0_4), .D1(mdout1_1_4), .D2(mdout1_2_4), .D3(mdout1_3_4), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[4]));

    MUX41 mux_10 (.D0(mdout1_0_5), .D1(mdout1_1_5), .D2(mdout1_2_5), .D3(mdout1_3_5), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[5]));

    MUX41 mux_9 (.D0(mdout1_0_6), .D1(mdout1_1_6), .D2(mdout1_2_6), .D3(mdout1_3_6), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[6]));

    MUX41 mux_8 (.D0(mdout1_0_7), .D1(mdout1_1_7), .D2(mdout1_2_7), .D3(mdout1_3_7), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[7]));

    MUX41 mux_7 (.D0(mdout1_0_8), .D1(mdout1_1_8), .D2(mdout1_2_8), .D3(mdout1_3_8), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[8]));

    MUX41 mux_6 (.D0(mdout1_0_9), .D1(mdout1_1_9), .D2(mdout1_2_9), .D3(mdout1_3_9), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[9]));

    MUX41 mux_5 (.D0(mdout1_0_10), .D1(mdout1_1_10), .D2(mdout1_2_10), .D3(mdout1_3_10), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[10]));

    MUX41 mux_4 (.D0(mdout1_0_11), .D1(mdout1_1_11), .D2(mdout1_2_11), .D3(mdout1_3_11), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[11]));

    MUX41 mux_3 (.D0(mdout1_0_12), .D1(mdout1_1_12), .D2(mdout1_2_12), .D3(mdout1_3_12), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[12]));

    MUX41 mux_2 (.D0(mdout1_0_13), .D1(mdout1_1_13), .D2(mdout1_2_13), .D3(mdout1_3_13), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[13]));

    MUX41 mux_1 (.D0(mdout1_0_14), .D1(mdout1_1_14), .D2(mdout1_2_14), .D3(mdout1_3_14), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[14]));

    MUX41 mux_0 (.D0(mdout1_0_15), .D1(mdout1_1_15), .D2(mdout1_2_15), .D3(mdout1_3_15), 
        .SD1(addr110_ff), .SD2(addr111_ff), .Z(QB[15]));
