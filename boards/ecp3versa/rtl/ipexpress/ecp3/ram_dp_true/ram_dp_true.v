...
/* Module Version: 7.2 */
/* C:\lscc\diamond\2.2\ispfpga\bin\nt\scuba.exe -w -n ram_dp_true -lang verilog -synth synplify -bus_exp 7 -bb -arch ep5c00 -type bram -wp 11 -rp 1010 -data_width 16 -rdata_width 16 -num_rows 4096 -byte 8 -writemodeA NORMAL -writemodeB NORMAL -cascade -1 -e  */
...
module ram_dp_true (DataInA, DataInB, ByteEnA, ByteEnB, AddressA, 
    ...
    MUX41 mux_22 (.D0(mdout0_0_10), .D1(mdout0_1_10), .D2(mdout0_2_10), 
        .D3(mdout0_3_10), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[9]));

    MUX41 mux_21 (.D0(mdout0_0_11), .D1(mdout0_1_11), .D2(mdout0_2_11), 
        .D3(mdout0_3_11), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[10]));

    MUX41 mux_20 (.D0(mdout0_0_12), .D1(mdout0_1_12), .D2(mdout0_2_12), 
        .D3(mdout0_3_12), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[11]));

    MUX41 mux_19 (.D0(mdout0_0_13), .D1(mdout0_1_13), .D2(mdout0_2_13), 
        .D3(mdout0_3_13), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[12]));

    MUX41 mux_18 (.D0(mdout0_0_14), .D1(mdout0_1_14), .D2(mdout0_2_14), 
        .D3(mdout0_3_14), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[13]));

    MUX41 mux_17 (.D0(mdout0_0_15), .D1(mdout0_1_15), .D2(mdout0_2_15), 
        .D3(mdout0_3_15), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[14]));

    MUX41 mux_16 (.D0(mdout0_0_16), .D1(mdout0_1_16), .D2(mdout0_2_16), 
        .D3(mdout0_3_16), .SD1(addr010_ff), .SD2(addr011_ff), .Z(QA[15]));
