...
static int __init ethpipe_init(void)
{
	...
	for ( i = 0; i < (MAX_TEMP_BUF-4096); ) {
		memcpy( mmio_ptr+i, "FFFFFFFFFFFF 0022CF63967B 8899 23 1E 0A CF E5 3A DF 00 22 CF 63 96 7B 00 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 \n", 170);
		switch ( num % 10 ) {
